...
const players = Object.fromEntries([
  ...
  P('9509', 'Bijan Robinson', 'RB', 'ATL', 4430807), P('8155', 'Breece Hall', 'RB', 'NYJ', 4427366),
  P('9221', 'Jahmyr Gibbs', 'RB', 'DET', 4429795), P('6794', 'Justin Jefferson', 'WR', 'MIN', 4262921),
  P('7564', 'Ja\'Marr Chase', 'WR', 'CIN', 4362628), P('6786', 'CeeDee Lamb', 'WR', 'DAL', 4241389),
  P('8146', 'Garrett Wilson', 'WR', 'NYJ', 4569618), P('4034', 'Christian McCaffrey', 'RB', 'SF', 3117251),
  P('9493', 'Puka Nacua', 'WR', 'LAR', 4426515), P('7553', 'Kyle Pitts', 'TE', 'ATL', 4360248),
  P('1466', 'Travis Kelce', 'TE', 'KC', 15847), P('4227', 'Harrison Butker', 'K', 'KC', 3055899),
  P('8259', 'Cameron Dicker', 'K', 'LAC', 4362081),
  ...
  P('11620', 'Rome Odunze', 'WR', 'CHI', 4431299), P('7610', 'Trey Lance', 'QB', null, 4383351),
  P('8151', 'Kenneth Walker', 'RB', 'SEA', 4567048), P('6813', 'Jonathan Taylor', 'RB', 'IND', 4242335),
...
const rosterA = { roster_id: 1, owner_id: 'u1', players: ['4984', '9509', '8155', '6794', '7564', '7553', '9221', '4227', 'BAL', '11620', '7610', '8151', '90001'] };
const rosterB = { roster_id: 2, owner_id: 'u2', players: ['4046', '4034', '6813', '6786', '8146', '1466', '9493', '8259', 'SF', '90002'] };
...
function matchups() {
  t += 1;
  const ppA = { 4984: 24.18 + t * 0.3, 9509: 14.4, 8155: 7.1, 6794: 0, 7564: 21.7, 7553: 3.5, 9221: 18.9, 4227: 9, BAL: 6, 11620: 4.2, 8151: 11.1 };
  const ppB = { 4046: 19.2, 4034: 22.4, 6813: 12.9, 6786: 0, 8146: 6.3, 1466: 8.8, 9493: 15.5, 8259: 7, SF: 4 };
  const sum = (pp, st) => st.reduce((a, id) => a + (pp[id] || 0), 0);
  const stA = ['4984', '9509', '8155', '6794', '7564', '7553', '9221', '4227', 'BAL'];
  const stB = ['4046', '4034', '6813', '6786', '8146', '1466', '9493', '8259', 'SF'];
  return [
...
function weekStats() {
  return [
    ...
    statRow('9509', { rush_yd: 64, rush_td: 1, rec: 3, rec_yd: 20 }), statRow('8155', { rush_yd: 31, rec: 2, rec_yd: 20 }),
    statRow('7564', { rec: 7, rec_yd: 97, rec_td: 1 }), statRow('7553', { rec: 2, rec_yd: 15, bonus_rec_te: 2 }),
    statRow('4227', { fgm_40_49: 1, xpm: 3, fgm: 1 }), statRow('BAL', { sack: 2, int: 1, pts_allow_21_27: 1, pts_allow: 24 }),
    ...
    statRow('8151', { rush_yd: 61, rec: 2, rec_yd: 30 }), statRow('11620', { rec: 2, rec_yd: 22 }), statRow('8259', { xpm: 4, fgm_30_39: 1, fgm: 1 }),
    statRow('SF', { sack: 1, pts_allow_7_13: 1, pts_allow: 10 }),
  ];
}
const projections = [
  statRow('6794', { rec: 6.2, rec_yd: 88, rec_td: 0.6 }), statRow('6786', { rec: 7.1, rec_yd: 94, rec_td: 0.5 }), statRow('9221', { rush_yd: 78, rush_td: 0.7, rec: 4, rec_yd: 32 }),
  statRow('9493', { rec: 6.5, rec_yd: 81, rec_td: 0.4 }), statRow('4984', { pass_yd: 260, pass_td: 2.1, rush_yd: 30, rush_td: 0.5 }), statRow('4046', { pass_yd: 275, pass_td: 2.2 }),
...
const routes = [
  ...
  [/\/league\/(?:L\d|123)$/, (u) => (u.endsWith('L2') ? league2 : league)],
  [/\/league\/(?:L\d|123)\/rosters$/, () => [rosterA, rosterB, ...others]],
  [/\/league\/(?:L\d|123)\/users$/, () => users],
  [/\/league\/(?:L\d|123)\/matchups\/\d+$/, () => matchups()],
  [/\/players\/nfl$/, () => players],
